...
{/* Recent work to showcase */}
          <div className="mt-16">
            ...
            <div className="signature-container mt-8" style={{ width: '10em', display: 'inline-block' }}>
             <svg viewBox="0 0 1683 809" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', display: 'block' }}>
